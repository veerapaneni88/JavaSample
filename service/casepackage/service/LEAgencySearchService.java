...
public interface LEAgencySearchService {

	/**
	 * 
	 * This Method will retrieve rows from the CAPS_RESOURCE table given
	 * CD_RSRC_TYPE as 'Law Enforcement Agency' CD_RSRC_STATUS as 'Active'
	 * CD_RSRC_STATE as 'Taxes' And one of the following search criteria
	 * nm_resource, addr_rsrc_city or cd_rsrc_cnty
	 * 
	 * @param leAgencySearchReq
	 * @return LEAgencySearchRes @
	 */

	public LEAgencySearchRes getLawEnforcementAgencyList(LEAgencySearchReq leAgencySearchReq);
