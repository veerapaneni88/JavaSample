...
@Component
public class NotifToParentProfSpPrefillData extends DocumentServiceUtil {

    private static final Logger logger = Logger.getLogger(NotifToParentProfSpPrefillData.class);


    @Override
    public PreFillDataServiceDto returnPrefillData(Object parentObj) {

        NotifToParentProfSpDto prefillDto = (NotifToParentProfSpDto) parentObj;
        ...
        //code for ccf14o00 and group ccf14o03
        ...
        //code for ccf14o00 and group ccf14o06
        ...
        //code for ccf14o00 and group ccf14o01
        ...
        for (PersonDetailsdoDto personDetailsdoDto : prefillDto.getPersonDetailsdoDtoList()) {
            if (CodesConstant.CSEX_F.equals(personDetailsdoDto.getCCdPersonSex())) {
                ...
                //code for ccf14o00 and group ccf14o05
