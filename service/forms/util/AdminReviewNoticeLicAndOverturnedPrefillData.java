...
@Component
public class AdminReviewNoticeLicAndOverturnedPrefillData extends DocumentServiceUtil {
    @Override
    public PreFillDataServiceDto returnPrefillData(Object parentDtoobj) {
        ...
        bookmarkNonFormGroupList.add(createBookmarkWithCodesTable(BookmarkConstants.CURRENT_DISPOSITION,
                prefillDto.getStageReviewYesDto().get(0).getCdAdminAllegDispostion(), CodesConstant.CDISPSTN));
