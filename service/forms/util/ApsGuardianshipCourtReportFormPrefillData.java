 ...
 */
@Repository
public class ApsGuardianshipCourtReportFormPrefillData extends DocumentServiceUtil {
    ...
    public PreFillDataServiceDto returnPrefillData(Object parentDtoobj) {
        ...
        if (null == apsCourtReportGuardianshipDataDto.getNameDetailDto()) {
            apsCourtReportGuardianshipDataDto.setNameDetailDto(new NameDetailDto());
        }

        if (null == apsCourtReportGuardianshipDataDto.getEmployeePersPhNameDto()) {
            apsCourtReportGuardianshipDataDto.setEmployeePersPhNameDto(new EmployeePersPhNameDto());
        }

        if (null == apsCourtReportGuardianshipDataDto.getPhyAddr()) {
            apsCourtReportGuardianshipDataDto.setPhyAddr(new ArrayList<>());
        }

        if (null == apsCourtReportGuardianshipDataDto.getStagePersonDto()) {
            apsCourtReportGuardianshipDataDto.setStagePersonDto(new StagePersonDto());
        }

        if (null == apsCourtReportGuardianshipDataDto.getCodesTablesDto()) {
            apsCourtReportGuardianshipDataDto.setCodesTablesDto(new CodesTablesDto());
        }

        if (null == apsCourtReportGuardianshipDataDto.getEventDtls()) {
            apsCourtReportGuardianshipDataDto.setEventDtls(new ArrayList<>());
        }

        if (null == apsCourtReportGuardianshipDataDto.getResourceValueBeanDto()) {
            apsCourtReportGuardianshipDataDto.setResourceValueBeanDto(new ResourceValueBeanDto());
        }
        ...
        if (null != apsCourtReportGuardianshipDataDto.getNameDetailDto().getCdNameSuffix()) {
            BookmarkDto bkWardSuffixName = createBookmark(BookmarkConstants.WARD_NAME_SUFFIX,
                    apsCourtReportGuardianshipDataDto.getNameDetailDto().getCdNameSuffix());
