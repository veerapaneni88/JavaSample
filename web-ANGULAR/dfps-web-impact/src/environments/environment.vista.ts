export const environment = {
  production: false,
  environmentName: 'VISTA',
  disableConsole: true,
  idleSessionDuration: 1800,
  apiUrl: 'https://vista2.dfps.texas.gov/dfps-pageapi-impact',
  impactLoginUrl: 'https://vista2.dfps.texas.gov/web/login',
  impactP2WebUrl: 'https://vista2.dfps.texas.gov/web',
  impactRefreshTokenAuth: 'SU1QQUNUUEgzOklNUEFDVC1QSDMtUkVGUkVTSA==',
  formsUrl: 'https://vista2.dfps.texas.gov/web/document/launch',
  helpUrl: 'https://vista2.dfps.texas.gov/web/resources/help/index.htm#t=Page_Descriptions/Finance/',
