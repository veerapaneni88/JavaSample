export const environment = {
  production: false,
  environmentName: 'dev18',
  disableConsole: true,
  idleSessionDuration: 1800,
  apiUrl: 'https://p2dev18.dfps.texas.gov/dfps-pageapi-impact',
  impactLoginUrl: 'https://p2dev18.dfps.texas.gov/web/login',
  impactP2WebUrl: 'https://p2dev18.dfps.texas.gov/web',
  impactRefreshTokenAuth: 'SU1QQUNUUEgzOklNUEFDVC1QSDMtUkVGUkVTSA==',
  formsUrl: 'https://p2dev18.dfps.texas.gov/web/document/launch',
  helpUrl: 'https://p2dev18.dfps.texas.gov/web/resources/help/index.htm#t=Page_Descriptions/Finance/',
