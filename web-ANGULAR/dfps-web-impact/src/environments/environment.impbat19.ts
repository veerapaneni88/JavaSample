export const environment = {
  production: false,
  environmentName: 'impbat19',
  disableConsole: true,
  idleSessionDuration: 1800,
  apiUrl: 'https://p2impbat19.dfps.texas.gov/dfps-pageapi-impact',
  impactLoginUrl: 'https://p2impbat19.dfps.texas.gov/web/login',
  impactP2WebUrl: 'https://p2impbat19.dfps.texas.gov/web',
  impactRefreshTokenAuth: 'SU1QQUNUUEgzOklNUEFDVC1QSDMtUkVGUkVTSA==',
  formsUrl: 'https://p2impbat19.dfps.texas.gov/web/document/launch',
  helpUrl: 'https://p2impbat19.dfps.texas.gov/web/resources/help/index.htm#t=Page_Descriptions/Finance/',
  ...
  jwtTokenEndpoint: 'https://p2impbat19.dfps.texas.gov/dfps-security-oauth2/oauth/token',
    ...
    config: {
        auth: {
          ...
          authority: 'https://login.microsoftonline.com/057119a8-cdc3-47b9-91d4-8bd4e013a246',
            ...
            redirectUri: 'https://p2impbat19.dfps.texas.gov/impact3/',
            postLogoutRedirectUri: 'https://p2impbat19.dfps.texas.gov/web/login/',
