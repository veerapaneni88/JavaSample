export const environment = {
  ...
  apiUrl: 'https://p2dev19.dfps.texas.gov/dfps-pageapi-impact',
  impactLoginUrl: 'https://p2dev19.dfps.texas.gov/web/login',
  impactP2WebUrl: 'https://p2dev19.dfps.texas.gov/web',
  impactRefreshTokenAuth: 'SU1QQUNUUEgzOklNUEFDVC1QSDMtUkVGUkVTSA==',
  formsUrl: 'https://p2dev19.dfps.texas.gov/web/document/launch',
  helpUrl: 'https://p2dev19.dfps.texas.gov/web/resources/help/index.htm#t=Page_Descriptions/Finance/',
  ...
  ternaryNavigation: ['authProvider', 'contract', 'invoice', 'financialAccntSearch', 'financialAccntDetail',
    ...
    jwtTokenEndpoint: 'https://p2dev19.dfps.texas.gov/dfps-security-oauth2/oauth/token',
    ...
    config: {
        auth: {
            ...
            redirectUri: 'https://p2dev19.dfps.texas.gov/impact3/',
            postLogoutRedirectUri: 'https://p2dev19.dfps.texas.gov/web/login/',
