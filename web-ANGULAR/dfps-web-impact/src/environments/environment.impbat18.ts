export const environment = {
  production: false,
  environmentName: 'impbat18',
  disableConsole: true,
  idleSessionDuration: 1800,
  apiUrl: 'https://p2impbat18.dfps.texas.gov/dfps-pageapi-impact',
  impactLoginUrl: 'https://p2impbat18.dfps.texas.gov/web/login',
  impactP2WebUrl: 'https://p2impbat18.dfps.texas.gov/web',
  impactRefreshTokenAuth: 'SU1QQUNUUEgzOklNUEFDVC1QSDMtUkVGUkVTSA==',
  formsUrl: 'https://p2impbat18.dfps.texas.gov/web/document/launch',
  helpUrl: 'https://p2impbat18.dfps.texas.gov/web/resources/help/index.htm#t=Page_Descriptions/Finance/',
  ...
  jwtTokenEndpoint: 'https://p2impbat18.dfps.texas.gov/dfps-security-oauth2/oauth/token',
    ...
    config: {
        auth: {
            ...
            redirectUri: 'https://p2impbat18.dfps.texas.gov/impact3/',
            postLogoutRedirectUri: 'https://p2impbat18.dfps.texas.gov/web/login/',
